...
public class Texture implements Resource {
  ...
  /**
   * Loads a texture from in, flipping it depending on fliphor horizontally, and
   * flipvert vertically.
   */
  ...
  /**
   * Loads a texture from bi, flipping it depending on fliphor horizontally, and
   * flipvert vertically.
   */
  ...
  /**
   * Loads a texture from in, flipping it depending on fliphor horizontally, and
   * flipvert vertically, filtered through filter.
   */
  ...
  /**
   * Loads a texture from in, flipping it depending on fliphor horizontally, and
   * flipvert vertically, rotated by rot, filtered through filter.
   */
