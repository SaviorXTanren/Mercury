...
public class CheckBox extends Component {
    ...
    public CheckBox(String txt, float x, float y, Color textcolor, Font font) {
        this(txt, x, y, getDefaultTextures().getTexture(5), getDefaultTextures().getTexture(6), getDefaultTextures()
                .getTexture(5).getWidth(), true, textcolor, font);
    }
    
    public CheckBox(String txt, float x, float y, float boxsize) {
        this(txt, x, y, getDefaultTextures().getTexture(5), getDefaultTextures().getTexture(6), boxsize, true,
    ...
    public CheckBox(String txt, float x, float y, float boxsize, boolean boxtoleftoftext, Font font) {
        this(txt, x, y, getDefaultTextures().getTexture(5), getDefaultTextures().getTexture(6), boxsize,
