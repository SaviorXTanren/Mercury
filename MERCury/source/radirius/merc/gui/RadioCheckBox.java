...
public class RadioCheckBox extends CheckBox {
    ...
    public RadioCheckBox(ArrayList<RadioCheckBox> group, String txt, float x, float y, Color textcolor, Font font) {
        this(group, txt, x, y, getDefaultTextures().getTexture(5), getDefaultTextures().getTexture(6), Math.max(
                getDefaultTextures().getTexture(6).getWidth(), getDefaultTextures().getTexture(5).getWidth()), true,
                textcolor, font);
    }
    
    public RadioCheckBox(ArrayList<RadioCheckBox> group, String txt, float x, float y, float boxsize) {
        this(group, txt, x, y, getDefaultTextures().getTexture(0), getDefaultTextures().getTexture(1), boxsize, true,
    ...
    public RadioCheckBox(ArrayList<RadioCheckBox> group, String txt, float x, float y, float boxsize,
            boolean boxtoleftoftext, Font font) {
        this(group, txt, x, y, getDefaultTextures().getTexture(0), getDefaultTextures().getTexture(1), boxsize,
    ...
    public RadioCheckBox(ArrayList<RadioCheckBox> group, String txt, float x, float y, Texture unchecked,
            Texture checked, float boxsize, boolean boxtoleftoftext, Color textcolor, Font font) {
