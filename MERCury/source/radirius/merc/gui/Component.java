...
public class Component implements Updatable, Renderable {
    ...
    public static SpriteSheet getDefaultTextures() {
        if (defaulttextures == null) {
            // The base texture!
            Texture spritesheet_texture = Texture.loadTexture(Loader
                    .streamFromClasspath("radirius/merc/gui/gui_spritesheet.png"));
            ...
            defaulttextures = SpriteSheet.loadSpriteSheet(spritesheet_texture, window_bar, panel_body, panel_border,
                    button_left, button_body, checkbox_unchecked, checkbox_checked, imagebutton_idle,
                    imagebutton_hover, imagebutton_active, text_field_left, text_field_body);
        }
