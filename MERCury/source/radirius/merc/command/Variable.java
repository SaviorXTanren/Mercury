...
public abstract class Variable {
  ...
  /**
   * The manual that will be shown when requested by the console user. Used for
   ...
   *          The name of the variable. This will be case-insensitive.
   * @param manual
   *          The manual that will be shown when requested by the console user.
   *          Used for general instruction of using the variable.
   */
  ...
  /**
   * @param args
   *          The given arguments of the variable. Use this info to return info!
