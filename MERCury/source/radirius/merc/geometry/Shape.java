...
public class Shape {
  ...
  /**
   * @param coords
   *          The coordinates of all vertices in the shape. Will be parsed for
   *          every 2 values into a Vec2.
   */
   ...
   * 
   * @param x
   *          Where every vertex should move relative to the nearest point of
   *          the shape on x.
   * @param y
   *          Where every vertex should move relative to the nearest point of
   *          the shape on y.
  ...
  /**
   * Makes me an orphan. Parent will lose me from it's arraylist of children, so
   * there is no trace of my previous life ;(.
   * 
   * @returns Me
   */
