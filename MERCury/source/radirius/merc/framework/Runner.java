...
public class Runner {
  ...
  /**
   * An object that will be used for initializing the Runner with default values
  ...
  /**
   * Adds information to the debugdata. Debug data is wiped every single update
   * frame, so this is to be called every frame.
   */
