...
public abstract class Core {
   ...
   * {@code initAudio}), used to initialize all resources, and for whatever you
   * wish to do for initialization. Runs on a seperate thread, while the main
   * Thread continues to the game loop.
   */
  public abstract void init();
  
  /**
   * Called once every frame, and used to handle all logic. It is suggested that
   * you check that initialization has passed before you use resources.
   */
  public abstract void update(float delta);
  
  /**
   * Called once every frame, and used to render everything, via
   * {@code Graphics g}. It is suggested that you check that initialization has
   * passed before you use resources.
   */
