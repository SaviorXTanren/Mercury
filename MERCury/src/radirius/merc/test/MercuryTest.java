...
/**
 * This is a testing program for most of Mercury's functionality. Should only be
 * used for debugging.
 *
 * Note: Is full of *really* hackish code. For testing purposes only, should
 * never be used as a demo.
 *
 * @author Jeviny
 */
