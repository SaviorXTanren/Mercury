...
import radirius.merc.graphics.gui.TextButton;
...
public class TestGUI extends Core {
    ...
    public void init() {
        ...
        window = new Window("Game Settings", new Color(220, 220, 220), new Rectangle(30, 76, 500, 500));
        ...
        window.addNewLine();
        window.addChild(new TextButton("Exit", 0, 0));
        window.sortChildren();
        
        tex0 = Texture.loadTexture(Loader.streamFromClasspath("radirius/merc/test/merc_mascot.png"));
        tex1 = Texture.loadTexture(Loader.streamFromClasspath("radirius/merc/test/merc_mascotd.png"));
        ...
        bounds = new Rectangle(runner.getWidth() - 275, screen_center.y - 84, tex0.getWidth());
    ...
    public void update(float delta) {
        ...
        emitter.getOptions().texture = particle_texture_check.isTicked() ? tex1 : null;
    ...
    public void render(Graphics g) {
        g.drawTexture(bg, new Rectangle(0, 0, runner.getWidth(), runner.getHeight()));
        ...
        g.setFont(fnt0);
        g.drawString("This is just a test! Demos Coming Soon.", 16, runner.getHeight() - 78);
