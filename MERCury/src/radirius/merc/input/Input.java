...
public class Input {
    ...
    /** @return Whether or not the button on controller is down. */
    public boolean controllerButtonDown(int button, int controller) {
        if (!Controllers.isCreated())
            try {
                throw new MERCuryException("Controllers not initialized.");
