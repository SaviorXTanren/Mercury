...
//        g.drawCircle(position.x, position.y, 10);
        ...
        g.drawTexture(texture, position.x-texture.getTextureWidth()/2, position.y-texture.getTextureHeight()/2);
        for (Vec2 pos : steroids) {
            g.setColor(Color.green);
            // Still draw a circle!
            g.drawCircle(pos.x, pos.y, 10);
            // Draw the texture!
            g.drawTexture(texture, pos.x-texture.getTextureWidth()/2, pos.y-texture.getTextureHeight()/2);
        }
