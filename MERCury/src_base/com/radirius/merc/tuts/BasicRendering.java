 ...
 * @license (C) Jan 20, 2014 www.wessles.com This file, and all others of the
...
public class BasicRendering extends Core
{
    ...
    {
        /**
         * Let's initialize the graphics by scaling and all dat background infos
         * (pun).
         */
    ...
    {
        /**
         * Let's start with simple rectangle, placed at 10, 10 with a width of
        ...
        /**
         * 'x' is declared outside of the render() method. This will just add
