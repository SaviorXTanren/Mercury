...
public class Polygon extends Shape {
	...
	/**
	 * Creates a new Polygon taking in the center position on
	 * the x/y axis, radius and number of sides.
	 * 
	 * @param xCenter
	...
	/**
	 * Creates a new Polygon taking in the center position on
	 * the x/y axis, x/y radius and number of sides.
	 * 
	 * @param xCenter
	 *            The center x position.
	 * @param yCenter
	...
	protected static Vector2f[] getTrigVerts(float x, float y, float xRadius, float yRadius, int numSides) {
		...
		// Start at 270, so that we have an upwards-facing polygon. More fun that way.
