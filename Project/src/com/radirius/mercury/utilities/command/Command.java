...
/**
 * A Command that will do a specific task when asked in the
 * given InputStream (by default, the console).
 *
 * @author wessles
 */
public abstract class Command {
    /**
     * The name of the command. This will be
     * case-insensitive.
     */
    ...
    /**
     * @param name   The name of the command. This will be
     *               case-insensitive.
     ...
     *
     * @param args The arguments given for the command. You
     *             do not need to use these.
     */
