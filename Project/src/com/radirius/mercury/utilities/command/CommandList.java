...
/**
 * A collection of Commands and Variables to be accessed in the given InputStream (the console by default).
 *
 * @author wessles
 */
public class CommandList {
	...
	/**
	 * @param name   The name of the command list. This will be case-insensitive.
