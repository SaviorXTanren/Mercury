...
/**
 * A simple Utility class for the Graphics engine which
 * contains some utility OpenGL rendering functions which
 * are required by the classes in this graphics package.
 * <p/>
 * This class also emulates Matrix-Stack, to simplify the
 * access to Modern OpenGL methods, mainly for Batcher,
 * Camera and the Graphics classes.
 *
