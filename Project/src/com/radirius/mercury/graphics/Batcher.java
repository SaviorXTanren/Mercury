...
public interface Batcher {
	 ...
	 * @param activeIndex The index of the active texture to set (i.e. 'GL13.GL_TEXTURE0').
	 */
	 ...
	 *
	 * @param activateIndex The index of the active texture (i.e. 'GL13.GL_TEXTURE0').
	 */
	...
	/**
	 * Draws a Texture texture at x and y at w and h size, rotated rot degrees by the local origin (local_origin_x,
	 * local_origin_y).
	 */
	...
	/**
	 * Will flush the data to OpenGL if the sum of the vertex count and the allocation is higher than the limit.
	 *
	 * @param allocate The amount of vertices that will be rendered in the next vertex-group.
	 */
